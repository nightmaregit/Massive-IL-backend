      ...
      <div className="flex">
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="pt-8 bg-white pb-[53px] rounded-b-[20px] px-6">
            <h1 className="text-3xl font-medium leading-normal ml-[30px] flex p-1 px-2 cursor-pointer border rounded-md w-[341px] border-black items-center gap-2">
              <FaPlus className="w-5" /> <span>Edit Akun</span>
            </h1>
